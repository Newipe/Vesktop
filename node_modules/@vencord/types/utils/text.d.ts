 ...
 */
export declare function formatDurationVerbose(time: number, unit: Units, short?: boolean): string;
export declare function formatDuration(ms: number, human?: boolean): string;
/**
