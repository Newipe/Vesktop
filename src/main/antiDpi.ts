...
const TLS_FINGERPRINTS = {
    chrome: {
        ...
        extensions: [
            ...
            0x001b, 0x0023, 0x002b, 0x002d, 0x0033, 0xff01, 0x4469
        ],
        tlsVersion: 0x0303,
    ...
    firefox: {
        cipherSuites: [
            0x1301, 0x1302, 0x1303, 0x1304, 0xc02b, 0xc02f, 0xcca9, 0xcca8,
            0xc00a, 0xc014, 0x009c, 0x009d, 0x002f, 0x0035
        ],
        extensions: [
            0x0000, 0x0005, 0x000a, 0x000b, 0x000d, 0x0010, 0x0012, 0x0017,
            0x001b, 0x0023, 0x002b, 0x002d, 0x0033, 0xff01, 0xfe0d
        ],
        tlsVersion: 0x0303,
        compressionMethods: [0x00]
    },
...
class AntiDpiManager {
    ...
    public recordConnection(success: boolean, parameters?: { fragmentCount: number; fragmentDelay: number }) {
        ...
        if (this.stats.totalConnections > 0) {
            this.stats.currentSuccessRate =
                (this.stats.successfulBypasses / this.stats.totalConnections) * 100;
        }
